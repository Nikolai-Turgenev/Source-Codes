...
#define TOKEN_QUERY     "/bin/busybox puzzles"
#define TOKEN_RESPONSE  "puzzles: applet not found"

#define EXEC_QUERY     "/bin/busybox puzzles"
#define EXEC_RESPONSE  "puzzles: applet not found"

#define FN_DROPPER  "PrOtOn"
#define FN_BINARY   "PrOtOn"
